...
- [x] ⚡ **MCP Client 接入层 + Tool Registry + ToolSpec 映射** — `P0-05` §11 M1 — 5d
- [x] **Credential Vault（信封加密）+ OAuth 流程** — `P0-05` §11 M2 — 4d
...
- [x] **MCP 只读连接器** —— Calendar / Notion / Gmail 只读 + GitHub 三档代表工具、信封加密 Vault、连接管理 UI — `P0-05` M1–M4、M7

**未完成的部分**：Custom Provider / SSRF（M6b）、Skill、写能力韧性在阶段 5。P0-05 M5/M6（写/不可撤销联调与熔断）仍在阶段 5。
